...
void Stbtt_temp_region_obj::__construct(){
            	HX_STACK_FRAME("kha.graphics2.truetype.Stbtt_temp_region","new",0xdcdd6e5e,"kha.graphics2.truetype.Stbtt_temp_region.new","kha/graphics2/truetype/StbTruetype.hx",43,0x5d9e0de9)
            	HX_STACK_THIS(this)
            	}
...
static void Stbtt_temp_region_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Stbtt_temp_region_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void Stbtt_temp_region_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
void Stbtt_temp_region_obj::__register()
{
	...
	__mClass->mMarkFunc = Stbtt_temp_region_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = Stbtt_temp_region_obj_sVisitStatics;
#endif
