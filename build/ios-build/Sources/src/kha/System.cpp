...
void System_obj::notifyOnApplicationState( ::Dynamic foregroundListener, ::Dynamic resumeListener, ::Dynamic pauseListener, ::Dynamic backgroundListener, ::Dynamic shutdownListener){
            	HX_STACK_FRAME("kha.System","notifyOnApplicationState",0x2a2d33fe,"kha.System.notifyOnApplicationState","kha/System.hx",40,0xeb7aee24)
...
HXLINE(  41)		Bool _hx_tmp = hx::IsNotNull( foregroundListener );
HXDLIN(  41)		if (_hx_tmp) {
HXLINE(  41)			::kha::System_obj::foregroundListeners->push(foregroundListener);
            		}
HXLINE(  42)		Bool _hx_tmp1 = hx::IsNotNull( resumeListener );
HXDLIN(  42)		if (_hx_tmp1) {
HXLINE(  42)			::kha::System_obj::resumeListeners->push(resumeListener);
            		}
HXLINE(  43)		Bool _hx_tmp2 = hx::IsNotNull( pauseListener );
HXDLIN(  43)		if (_hx_tmp2) {
HXLINE(  43)			::kha::System_obj::pauseListeners->push(pauseListener);
            		}
HXLINE(  44)		Bool _hx_tmp3 = hx::IsNotNull( backgroundListener );
HXDLIN(  44)		if (_hx_tmp3) {
HXLINE(  44)			::kha::System_obj::backgroundListeners->push(backgroundListener);
            		}
HXLINE(  45)		Bool _hx_tmp4 = hx::IsNotNull( shutdownListener );
HXDLIN(  45)		if (_hx_tmp4) {
HXLINE(  45)			::kha::System_obj::shutdownListeners->push(shutdownListener);
            		}
            	}
...
void System_obj::render(Int id, ::kha::Framebuffer framebuffer){
            	HX_STACK_FRAME("kha.System","render",0xde3fc50b,"kha.System.render","kha/System.hx",48,0xeb7aee24)
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(framebuffer,"framebuffer")
HXLINE(  49)		if ((::kha::System_obj::renderListeners->length == (int)0)) {
HXLINE(  50)			return;
            		}
HXLINE(  53)		{
HXLINE(  53)			HX_VARI( Int,_g) = (int)0;
HXDLIN(  53)			HX_VARI( ::Array< ::Dynamic>,_g1) = ::kha::System_obj::renderListeners->__get(id).StaticCast< ::Array< ::Dynamic> >();
HXDLIN(  53)			while((_g < _g1->length)){
HXLINE(  53)				HX_VARI(  ::Dynamic,listener) = _g1->__get(_g);
HXDLIN(  53)				++_g;
HXLINE(  54)				listener(framebuffer);
            			}
            		}
            	}
...
void System_obj::foreground(){
            	HX_STACK_FRAME("kha.System","foreground",0x0e2cf0f8,"kha.System.foreground","kha/System.hx",59,0xeb7aee24)
HXLINE(  59)		HX_VARI( Int,_g) = (int)0;
HXDLIN(  59)		HX_VARI( ::Array< ::Dynamic>,_g1) = ::kha::System_obj::foregroundListeners;
HXDLIN(  59)		while((_g < _g1->length)){
HXLINE(  59)			HX_VARI(  ::Dynamic,listener) = _g1->__get(_g);
HXDLIN(  59)			++_g;
HXLINE(  60)			listener();
            		}
            	}
...
void System_obj::resume(){
            	HX_STACK_FRAME("kha.System","resume",0xe19ac362,"kha.System.resume","kha/System.hx",65,0xeb7aee24)
HXLINE(  65)		HX_VARI( Int,_g) = (int)0;
HXDLIN(  65)		HX_VARI( ::Array< ::Dynamic>,_g1) = ::kha::System_obj::resumeListeners;
HXDLIN(  65)		while((_g < _g1->length)){
HXLINE(  65)			HX_VARI(  ::Dynamic,listener) = _g1->__get(_g);
HXDLIN(  65)			++_g;
HXLINE(  66)			listener();
            		}
            	}
...
void System_obj::pause(){
            	HX_STACK_FRAME("kha.System","pause",0xabf2eae1,"kha.System.pause","kha/System.hx",71,0xeb7aee24)
HXLINE(  71)		HX_VARI( Int,_g) = (int)0;
HXDLIN(  71)		HX_VARI( ::Array< ::Dynamic>,_g1) = ::kha::System_obj::pauseListeners;
HXDLIN(  71)		while((_g < _g1->length)){
HXLINE(  71)			HX_VARI(  ::Dynamic,listener) = _g1->__get(_g);
HXDLIN(  71)			++_g;
HXLINE(  72)			listener();
            		}
            	}
...
void System_obj::background(){
            	HX_STACK_FRAME("kha.System","background",0x235b6c23,"kha.System.background","kha/System.hx",77,0xeb7aee24)
HXLINE(  77)		HX_VARI( Int,_g) = (int)0;
HXDLIN(  77)		HX_VARI( ::Array< ::Dynamic>,_g1) = ::kha::System_obj::backgroundListeners;
HXDLIN(  77)		while((_g < _g1->length)){
HXLINE(  77)			HX_VARI(  ::Dynamic,listener) = _g1->__get(_g);
HXDLIN(  77)			++_g;
HXLINE(  78)			listener();
            		}
            	}
...
void System_obj::shutdown(){
            	HX_STACK_FRAME("kha.System","shutdown",0x79b3ed8b,"kha.System.shutdown","kha/System.hx",83,0xeb7aee24)
HXLINE(  83)		HX_VARI( Int,_g) = (int)0;
HXDLIN(  83)		HX_VARI( ::Array< ::Dynamic>,_g1) = ::kha::System_obj::shutdownListeners;
HXDLIN(  83)		while((_g < _g1->length)){
HXLINE(  83)			HX_VARI(  ::Dynamic,listener) = _g1->__get(_g);
HXDLIN(  83)			++_g;
HXLINE(  84)			listener();
            		}
            	}
...
HXLINE(  91)		return ::kha::SystemImpl_obj::getTime();
            	}
...
HXLINE(  95)		return ::kha::SystemImpl_obj::windowWidth(windowId);
            	}
...
Int windowId = __o_windowId.Default(0);
            	...
            	HX_STACK_ARG(windowId,"windowId")
HXLINE(  99)		return ::kha::SystemImpl_obj::windowHeight(windowId);
            	}
...
Int System_obj::screenDpi(){
            	HX_STACK_FRAME("kha.System","screenDpi",0xfc3b90bc,"kha.System.screenDpi","kha/System.hx",104,0xeb7aee24)
HXLINE( 104)		return ::kha::SystemImpl_obj::screenDpi();
            	}
...
::hx::EnumBase System_obj::get_screenRotation(){
            	HX_STACK_FRAME("kha.System","get_screenRotation",0xea0af6c8,"kha.System.get_screenRotation","kha/System.hx",110,0xeb7aee24)
HXLINE( 110)		return ::kha::SystemImpl_obj::getScreenRotation();
            	}
...
Bool System_obj::get_vsync(){
            	HX_STACK_FRAME("kha.System","get_vsync",0x459c6f93,"kha.System.get_vsync","kha/System.hx",116,0xeb7aee24)
HXLINE( 116)		return ::kha::SystemImpl_obj::getVsync();
            	}
...
Int System_obj::get_refreshRate(){
            	HX_STACK_FRAME("kha.System","get_refreshRate",0x2d9ee19d,"kha.System.get_refreshRate","kha/System.hx",122,0xeb7aee24)
HXLINE( 122)		return ::kha::SystemImpl_obj::getRefreshRate();
            	}
...
::String System_obj::get_systemId(){
            	HX_STACK_FRAME("kha.System","get_systemId",0x418f7428,"kha.System.get_systemId","kha/System.hx",128,0xeb7aee24)
HXLINE( 128)		return ::kha::SystemImpl_obj::getSystemId();
            	}
...
void System_obj::requestShutdown(){
            	HX_STACK_FRAME("kha.System","requestShutdown",0x3cb646b0,"kha.System.requestShutdown","kha/System.hx",132,0xeb7aee24)
HXLINE( 132)		::kha::SystemImpl_obj::requestShutdown();
            	}
...
void System_obj::changeResolution(Int width,Int height){
            	HX_STACK_FRAME("kha.System","changeResolution",0xbb1c64b1,"kha.System.changeResolution","kha/System.hx",136,0xeb7aee24)
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE( 136)		::kha::SystemImpl_obj::changeResolution(width,height);
            	}
...
void System_obj::loadUrl(::String url){
            	HX_STACK_FRAME("kha.System","loadUrl",0x235bc994,"kha.System.loadUrl","kha/System.hx",139,0xeb7aee24)
