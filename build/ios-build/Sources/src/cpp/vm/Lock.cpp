...
void Lock_obj::__construct(){
            	HX_STACK_FRAME("cpp.vm.Lock","new",0x9e13fec9,"cpp.vm.Lock.new","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/cpp/vm/Lock.hx",28,0xdb333ae5)
            	HX_STACK_THIS(this)
HXLINE(  28)		this->l = ::__hxcpp_lock_create();
            	}
...
Bool Lock_obj::wait( ::Dynamic __o_timeout){
 ::Dynamic timeout = __o_timeout.Default(-1);
            	HX_STACK_FRAME("cpp.vm.Lock","wait",0xb95ac7ec,"cpp.vm.Lock.wait","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/cpp/vm/Lock.hx",31,0xdb333ae5)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(timeout,"timeout")
HXLINE(  31)		return ::__hxcpp_lock_wait(this->l,timeout);
            	}
