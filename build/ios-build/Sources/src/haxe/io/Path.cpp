...
::String Path_obj::addTrailingSlash(::String path){
            	HX_STACK_FRAME("haxe.io.Path","addTrailingSlash",0x8b4f8e69,"haxe.io.Path.addTrailingSlash","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/haxe/io/Path.hx",262,0x8086b7bb)
...
::String Path_obj::removeTrailingSlashes(::String path){
            	HX_STACK_FRAME("haxe.io.Path","removeTrailingSlashes",0x2dc73462,"haxe.io.Path.removeTrailingSlashes","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/haxe/io/Path.hx",287,0x8086b7bb)
            	HX_STACK_ARG(path,"path")
