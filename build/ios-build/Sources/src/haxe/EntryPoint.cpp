...
hx::ObjectPtr< EntryPoint_obj > EntryPoint_obj::__new()
{
...
Float EntryPoint_obj::processEvents(){
            	HX_STACK_FRAME("haxe.EntryPoint","processEvents",0x04eb4e60,"haxe.EntryPoint.processEvents","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/haxe/EntryPoint.hx",91,0xa57a87b5)
HXLINE(  93)		while(true){
HXLINE(  95)			::haxe::EntryPoint_obj::mutex->acquire();
HXLINE(  96)			HX_VARI(  ::Dynamic,f) = ::haxe::EntryPoint_obj::pending->shift();
HXLINE(  97)			::haxe::EntryPoint_obj::mutex->release();
HXLINE( 101)			Bool _hx_tmp = hx::IsNull( f );
...
HXDLIN( 104)		Bool _hx_tmp2 = hx::IsNull( ::haxe::MainLoop_obj::pending );
HXDLIN( 104)		if (_hx_tmp2) {
HXLINE( 104)			_hx_tmp1 = (::haxe::EntryPoint_obj::threadCount == (int)0);
            		}
            		else {
...
void EntryPoint_obj::run(){
            	HX_STACK_FRAME("haxe.EntryPoint","run",0xf0324cc3,"haxe.EntryPoint.run","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/haxe/EntryPoint.hx",132,0xa57a87b5)
HXLINE( 132)		while(true){
HXLINE( 133)			HX_VARI( Float,nextTick) = ::haxe::EntryPoint_obj::processEvents();
HXLINE( 134)			if ((nextTick < (int)0)) {
HXLINE( 135)				goto _hx_goto_1;
            			}
HXLINE( 136)			if ((nextTick > (int)0)) {
HXLINE( 137)				::haxe::EntryPoint_obj::sleepLock->wait(nextTick);
            			}
            		}
            		_hx_goto_1:;
            	}
...
{
{
            	HX_STACK_FRAME("haxe.EntryPoint","boot",0x3138e7ba,"haxe.EntryPoint.boot","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/haxe/EntryPoint.hx",46,0xa57a87b5)
HXLINE(  46)		sleepLock =  ::cpp::vm::Lock_obj::__new();
            	}
{
            	HX_STACK_FRAME("haxe.EntryPoint","boot",0x3138e7ba,"haxe.EntryPoint.boot","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/haxe/EntryPoint.hx",47,0xa57a87b5)
HXLINE(  47)		mutex =  ::cpp::vm::Mutex_obj::__new();
            	}
{
            	HX_STACK_FRAME("haxe.EntryPoint","boot",0x3138e7ba,"haxe.EntryPoint.boot","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/haxe/EntryPoint.hx",49,0xa57a87b5)
HXLINE(  49)		pending = ::Array_obj< ::Dynamic>::__new();
            	}
{
            	HX_STACK_FRAME("haxe.EntryPoint","boot",0x3138e7ba,"haxe.EntryPoint.boot","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/haxe/EntryPoint.hx",51,0xa57a87b5)
HXLINE(  51)		threadCount = (int)0;
            	}
}
