...
void StringMap_obj::__construct(){
            	HX_STACK_FRAME("haxe.ds.StringMap","new",0x0f13f0c6,"haxe.ds.StringMap.new","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/cpp/_std/haxe/ds/StringMap.hx",52,0xe720036b)
            	HX_STACK_THIS(this)
            	}
...
void StringMap_obj::set(::String key, ::Dynamic value){
            	HX_STACK_FRAME("haxe.ds.StringMap","set",0x0f17bc08,"haxe.ds.StringMap.set","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/cpp/_std/haxe/ds/StringMap.hx",55,0xe720036b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC2(StringMap_obj,set,(void))
 ...
 ::Dynamic StringMap_obj::get(::String key){
            	HX_STACK_FRAME("haxe.ds.StringMap","get",0x0f0ea0fc,"haxe.ds.StringMap.get","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/cpp/_std/haxe/ds/StringMap.hx",59,0xe720036b)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
Bool StringMap_obj::exists(::String key){
            	HX_STACK_FRAME("haxe.ds.StringMap","exists",0xd35fc136,"haxe.ds.StringMap.exists","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/cpp/_std/haxe/ds/StringMap.hx",63,0xe720036b)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
