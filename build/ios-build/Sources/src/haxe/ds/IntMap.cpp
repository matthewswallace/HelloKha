...
void IntMap_obj::__construct(){
            	HX_STACK_FRAME("haxe.ds.IntMap","new",0x7222c4b6,"haxe.ds.IntMap.new","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/cpp/_std/haxe/ds/IntMap.hx",53,0xe97daed9)
            	HX_STACK_THIS(this)
            	}
...
void IntMap_obj::set(Int key, ::Dynamic value){
            	HX_STACK_FRAME("haxe.ds.IntMap","set",0x72268ff8,"haxe.ds.IntMap.set","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/cpp/_std/haxe/ds/IntMap.hx",56,0xe97daed9)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC2(IntMap_obj,set,(void))
 ...
 ::Dynamic IntMap_obj::get(Int key){
            	HX_STACK_FRAME("haxe.ds.IntMap","get",0x721d74ec,"haxe.ds.IntMap.get","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/cpp/_std/haxe/ds/IntMap.hx",60,0xe97daed9)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
Bool IntMap_obj::exists(Int key){
            	HX_STACK_FRAME("haxe.ds.IntMap","exists",0x63ba0346,"haxe.ds.IntMap.exists","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/cpp/_std/haxe/ds/IntMap.hx",64,0xe97daed9)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
HX_DEFINE_DYNAMIC_FUNC1(IntMap_obj,exists,return )
 ...
 ::Dynamic IntMap_obj::iterator(){
            	HX_STACK_FRAME("haxe.ds.IntMap","iterator",0x4dc7ddd8,"haxe.ds.IntMap.iterator","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/cpp/_std/haxe/ds/IntMap.hx",76,0xe97daed9)
            	HX_STACK_THIS(this)
