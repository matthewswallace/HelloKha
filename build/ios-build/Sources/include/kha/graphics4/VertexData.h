...
class VertexData_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String __ToString() const { return HX_HCSTRING("VertexData.","\xa0","\x70","\xf6","\xcc") + _hx_tag; }
		...
		static ::kha::graphics4::VertexData Float4x4;
		static inline ::kha::graphics4::VertexData Float4x4_dyn() { return Float4x4; }
};
