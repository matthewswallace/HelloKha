...
public class Date extends haxe.lang.HxObject
{
	...
	{
		//line 30 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
	...
	{
		//line 33 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
		if (( year != 0 )) 
		{
			//line 33 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
			year -= 1900;
		...
		//line 34 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
	...
	{
		//line 94 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
		haxe.root.Date d = new haxe.root.Date(0, 0, 0, 0, 0, 0);
		//line 95 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
		d.date = new java.util.Date();
		//line 96 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
		return d;
	}
	...
	{
		//line 101 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
		haxe.root.Date d = new haxe.root.Date(0, 0, 0, 0, 0, 0);
		//line 102 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
		d.date = new java.util.Date(((long) (t) ));
		//line 103 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
		return d;
	}
	...
	{
		//line 108 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
		int _g = s.length();
		//line 108 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
		switch (_g)
		{
			case 8:
			{
				//line 111 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
				haxe.root.Array<java.lang.String> k = haxe.lang.StringExt.split(s, ":");
				//line 112 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
				...
				//line 113 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
				return d;
			}
			...
			case 10:
			{
				//line 115 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
				haxe.root.Array<java.lang.String> k1 = haxe.lang.StringExt.split(s, "-");
				//line 116 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
			...
			case 19:
			{
				//line 118 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
				haxe.root.Array<java.lang.String> k2 = haxe.lang.StringExt.split(s, " ");
				//line 119 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
				haxe.root.Array<java.lang.String> y = haxe.lang.StringExt.split(k2.__get(0), "-");
				//line 120 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
				haxe.root.Array<java.lang.String> t = haxe.lang.StringExt.split(k2.__get(1), ":");
				//line 121 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
			...
			default:
			{
				//line 123 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
	...
	{
		//line 26 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/_std/Date.hx"
