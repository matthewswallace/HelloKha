...
public class DynamicObject extends haxe.lang.HxObject
{
	...
	{
		//line 43 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
	...
	public static void __hx_ctor_haxe_lang_DynamicObject(haxe.lang.DynamicObject __temp_me48)
	{
		//line 43 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
		__temp_me48.__hx_hashes = new java.lang.String[]{};
		//line 43 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
		__temp_me48.__hx_dynamics = new java.lang.Object[]{};
		//line 43 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
		__temp_me48.__hx_hashes_f = new java.lang.String[]{};
		//line 43 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
		__temp_me48.__hx_dynamics_f = new double[]{};
	}
	
	
	public static void __hx_ctor_haxe_lang_DynamicObject(haxe.lang.DynamicObject __temp_me47, java.lang.String[] __hx_hashes, java.lang.Object[] __hx_dynamics, java.lang.String[] __hx_hashes_f, double[] __hx_dynamics_f)
	{
		//line 43 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
		__temp_me47.__hx_hashes = __hx_hashes;
		//line 43 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
		__temp_me47.__hx_dynamics = __hx_dynamics;
		//line 43 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
		__temp_me47.__hx_hashes_f = __hx_hashes_f;
		//line 43 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
		__temp_me47.__hx_dynamics_f = __hx_dynamics_f;
		//line 43 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
		__temp_me47.__hx_length = __hx_hashes.length;
		//line 43 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
		__temp_me47.__hx_length_f = __hx_hashes_f.length;
	}
	...
	{
		//line 47 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
		haxe.lang.Function ts = ((haxe.lang.Function) (haxe.lang.Runtime.getField(this, "toString", false)) );
		//line 48 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
		boolean tmp = ( ts != null );
		//line 48 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
		if (tmp) 
		{
			//line 49 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
			return haxe.lang.Runtime.toString(ts.__hx_invoke0_o());
		}
		
		//line 50 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
		haxe.root.StringBuf ret = new haxe.root.StringBuf();
		//line 51 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
		ret.add(haxe.lang.Runtime.toString("{"));
		//line 52 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
		boolean first = true;
		//line 53 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
		{
			//line 53 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
			int _g = 0;
			//line 53 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
			...
			while (( _g < _g1.length ))
			{
				...
				//line 53 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
				 ++ _g;
				//line 55 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
				if (first) 
				{
					//line 56 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
					first = false;
				}
				else
				{
					//line 58 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
					ret.add(haxe.lang.Runtime.toString(","));
				}
				
				//line 59 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
				ret.add(haxe.lang.Runtime.toString(" "));
				//line 59 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
				ret.add(haxe.lang.Runtime.toString(f));
				//line 60 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
				ret.add(haxe.lang.Runtime.toString(" : "));
				//line 61 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
				ret.add(((java.lang.Object) (haxe.root.Reflect.field(this, f)) ));
			}
			
		}
		
		//line 63 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
		if ( ! (first) ) 
		{
			//line 63 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
			ret.add(haxe.lang.Runtime.toString(" "));
		...
		//line 64 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
		ret.add(haxe.lang.Runtime.toString("}"));
		//line 65 "/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/java/internal/HxObject.hx"
		return ret.toString();
	}
