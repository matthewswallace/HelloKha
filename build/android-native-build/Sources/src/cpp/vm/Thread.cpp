...
hx::ObjectPtr< Thread_obj > Thread_obj::__new()
{
...
Int Thread_obj::__compare( ::Dynamic t){
            	HX_STACK_FRAME("cpp.vm.Thread","__compare",0x3204cb4d,"cpp.vm.Thread.__compare","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/cpp/vm/Thread.hx",66,0xe5fe61e6)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(t,"t")
