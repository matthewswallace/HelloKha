...
void Bytes_obj::__construct(Int length,::Array< unsigned char > b){
            	HX_STACK_FRAME("haxe.io.Bytes","new",0x3938d57d,"haxe.io.Bytes.new","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/haxe/io/Bytes.hx",33,0x2dd6db71)
            	HX_STACK_THIS(this)
...
void Bytes_obj::blit(Int pos, ::haxe::io::Bytes src,Int srcpos,Int len){
            	HX_STACK_FRAME("haxe.io.Bytes","blit",0xd098ac78,"haxe.io.Bytes.blit","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/haxe/io/Bytes.hx",79,0x2dd6db71)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC4(Bytes_obj,blit,(void))
 ...
 ::haxe::io::Bytes Bytes_obj::sub(Int pos,Int len){
            	HX_STACK_FRAME("haxe.io.Bytes","sub",0x393cae9d,"haxe.io.Bytes.sub","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/haxe/io/Bytes.hx",133,0x2dd6db71)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(len,"len")
...
void Bytes_obj::setDouble(Int pos,Float v){
            	HX_STACK_FRAME("haxe.io.Bytes","setDouble",0xa657d930,"haxe.io.Bytes.setDouble","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/haxe/io/Bytes.hx",252,0x2dd6db71)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(v,"v")
...
void Bytes_obj::setFloat(Int pos,Float v){
            	HX_STACK_FRAME("haxe.io.Bytes","setFloat",0xdaed805d,"haxe.io.Bytes.setFloat","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/haxe/io/Bytes.hx",275,0x2dd6db71)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(v,"v")
...
::String Bytes_obj::getString(Int pos,Int len){
            	HX_STACK_FRAME("haxe.io.Bytes","getString",0xa16beae4,"haxe.io.Bytes.getString","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/haxe/io/Bytes.hx",360,0x2dd6db71)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(len,"len")
...
::String Bytes_obj::toString(){
            	HX_STACK_FRAME("haxe.io.Bytes","toString",0x0291226f,"haxe.io.Bytes.toString","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/haxe/io/Bytes.hx",440,0x2dd6db71)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(Bytes_obj,toString,return )
 ...
 ::haxe::io::Bytes Bytes_obj::alloc(Int length){
            	HX_STACK_FRAME("haxe.io.Bytes","alloc",0x2199ead2,"haxe.io.Bytes.alloc","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/haxe/io/Bytes.hx",462,0x2dd6db71)
            	HX_STACK_ARG(length,"length")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_obj,alloc,return )
 ...
 ::haxe::io::Bytes Bytes_obj::ofString(::String s){
            	HX_STACK_FRAME("haxe.io.Bytes","ofString",0x6e53bb0b,"haxe.io.Bytes.ofString","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/haxe/io/Bytes.hx",490,0x2dd6db71)
            	HX_STACK_ARG(s,"s")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_obj,ofString,return )
 ...
 ::haxe::io::Bytes Bytes_obj::ofData(::Array< unsigned char > b){
            	HX_STACK_FRAME("haxe.io.Bytes","ofData",0x4f3005e4,"haxe.io.Bytes.ofData","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/haxe/io/Bytes.hx",561,0x2dd6db71)
            	HX_STACK_ARG(b,"b")
