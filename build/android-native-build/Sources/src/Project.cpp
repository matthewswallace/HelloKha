...
void Project_obj::__construct(){
            	HX_STACK_FRAME("Project","new",0xf2be2c2b,"Project.new","Project.hx",13,0xbb0fc1a5)
            	HX_STACK_THIS(this)
HXLINE(  13)		::kha::Assets_obj::loadEverything(this->loadedEverything_dyn());
            	}
...
void Project_obj::loadedEverything(){
            	HX_STACK_FRAME("Project","loadedEverything",0xd0a2102d,"Project.loadedEverything","Project.hx",16,0xbb0fc1a5)
            	HX_STACK_THIS(this)
HXLINE(  17)		this->font1 = ::kha::Assets_obj::fonts->OpenSans_Regular;
HXLINE(  21)		::share::Share_obj::share(HX_("hello",12,33,c1,24),HX_("this is a test",a5,69,40,5d),HX_("http://mattwallace.me",d3,b5,07,0a),false);
