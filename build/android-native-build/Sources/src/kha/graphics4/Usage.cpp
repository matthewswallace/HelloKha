...
static void Usage_obj_sMarkStatics(HX_MARK_PARAMS) {
...
static void Usage_obj_sVisitStatic(HX_VISIT_PARAMS) {
...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_HCSTRING("kha.graphics4.Usage","\x92","\x83","\x45","\x64"), hx::TCanCast< Usage_obj >,Usage_obj_sStaticFields,0,
	&__Create_Usage_obj, &__Create,
	&super::__SGetClass(), &CreateUsage_obj, Usage_obj_sMarkStatics
#ifdef HXCPP_VISIT_ALLOCS
    , Usage_obj_sVisitStatic
#endif
...
{
DynamicUsage = hx::CreateEnum< Usage_obj >(HX_HCSTRING("DynamicUsage","\x42","\xed","\xeb","\x28"),1,0);
ReadableUsage = hx::CreateEnum< Usage_obj >(HX_HCSTRING("ReadableUsage","\xf1","\xba","\xca","\x36"),2,0);
StaticUsage = hx::CreateEnum< Usage_obj >(HX_HCSTRING("StaticUsage","\x73","\xd1","\x2e","\xa3"),0,0);
}
