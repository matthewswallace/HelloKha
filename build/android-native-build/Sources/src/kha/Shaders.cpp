...
HXLINE( 144)				{
HXLINE( 145)					HX_VARI_NAME( ::String,data5,"data") = ( (::String)(::Reflect_obj::field(hx::ClassOf< ::kha::Shaders >(),HX_("painter_video_fragData",74,e1,6c,f4))) );
HXLINE( 146)					HX_VARI_NAME(  ::haxe::io::Bytes,bytes5,"bytes") = ( ( ::haxe::io::Bytes)(::haxe::Unserializer_obj::run(data5)) );
HXLINE( 147)					::kha::Shaders_obj::painter_video_frag =  ::kha::graphics4::FragmentShader_obj::__new(::kha::Blob_obj::fromBytes(bytes5),HX_("painter_video_frag",2a,02,b3,75));
            				}
            			}
HXLINE( 125)			{
HXLINE( 126)				HX_VARI_NAME( ::String,data6,"data") = ( (::String)(::Reflect_obj::field(hx::ClassOf< ::kha::Shaders >(),HX_("painter_text_vertData",99,b1,3c,b2))) );
HXLINE( 127)				HX_VARI_NAME(  ::haxe::io::Bytes,bytes6,"bytes") = ( ( ::haxe::io::Bytes)(::haxe::Unserializer_obj::run(data6)) );
HXLINE( 128)				::kha::Shaders_obj::painter_text_vert =  ::kha::graphics4::VertexShader_obj::__new(::kha::Blob_obj::fromBytes(bytes6),HX_("painter_text_vert",cf,9b,24,d7));
            			}
            		}
HXLINE( 125)		{
