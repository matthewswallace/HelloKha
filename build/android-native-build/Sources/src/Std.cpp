...
Bool Std_obj::is( ::Dynamic v, ::Dynamic t){
            	HX_STACK_FRAME("Std","is",0x3c56d6f5,"Std.is","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/cpp/_std/Std.hx",24,0x9e3cb1bc)
            	HX_STACK_ARG(v,"v")
            	HX_STACK_ARG(t,"t")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Std_obj,is,return )
 ...
 ::Dynamic Std_obj::instance( ::Dynamic value,hx::Class c){
            	HX_STACK_FRAME("Std","instance",0x1431f4e0,"Std.instance","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/cpp/_std/Std.hx",28,0x9e3cb1bc)
...
::String Std_obj::string( ::Dynamic s){
            	HX_STACK_FRAME("Std","string",0xcf48855c,"Std.string","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/cpp/_std/Std.hx",32,0x9e3cb1bc)
            	HX_STACK_ARG(s,"s")
...
Int Std_obj::_hx_int(Float x){
            	HX_STACK_FRAME("Std","int",0x8fa53b84,"Std.int","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/cpp/_std/Std.hx",36,0x9e3cb1bc)
            	HX_STACK_ARG(x,"x")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Std_obj,_hx_int,return )
 ...
 ::Dynamic Std_obj::parseInt(::String x){
            	HX_STACK_FRAME("Std","parseInt",0x90c2ebc7,"Std.parseInt","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/cpp/_std/Std.hx",40,0x9e3cb1bc)
            	HX_STACK_ARG(x,"x")
...
Float Std_obj::parseFloat(::String x){
            	HX_STACK_FRAME("Std","parseFloat",0xbca10a74,"Std.parseFloat","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/cpp/_std/Std.hx",44,0x9e3cb1bc)
            	HX_STACK_ARG(x,"x")
...
Int Std_obj::random(Int x){
            	HX_STACK_FRAME("Std","random",0x75a77e8e,"Std.random","/usr/local/lib/haxe/lib/kha/git/Tools/haxe/std/cpp/_std/Std.hx",47,0x9e3cb1bc)
            	HX_STACK_ARG(x,"x")
