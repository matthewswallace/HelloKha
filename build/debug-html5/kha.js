...
Main.__name__ = true;
Main.main = function() {
	kha_System.init({ title : "Hello from Kha", width : 1024, height : 768},function() {
		new Project();
	});
};
Math.__name__ = true;
var Project = function() {
	kha_Assets.loadEverything($bind(this,this.loadedEverything));
};
$hxClasses["Project"] = Project;
Project.__name__ = true;
Project.prototype = {
	font1: null
	,loadedEverything: function() {
		this.font1 = kha_Assets.fonts.OpenSans_Regular;
		share_Share.share("hello","this is a test","http://mattwallace.me",false);
		kha_System.notifyOnRender($bind(this,this.render));
	}
	,render: function(framebuffer) {
		var graphic = framebuffer.get_g2();
		graphic.begin();
		graphic.set_font(this.font1);
		graphic.set_fontSize(64);
		graphic.set_color(kha__$Color_Color_$Impl_$.White);
...
var kha_FontList = function() {
	...
	this.OpenSans_SemiboldDescription = { files : ["OpenSans-Semibold.ttf"], type : "font", name : "OpenSans_Semibold"};
	this.OpenSans_SemiboldName = "OpenSans_Semibold";
	this.OpenSans_Semibold = null;
	this.OpenSans_RegularDescription = { files : ["OpenSans-Regular.ttf"], type : "font", name : "OpenSans_Regular"};
	this.OpenSans_RegularName = "OpenSans_Regular";
	this.OpenSans_Regular = null;
	this.OpenSans_LightItalicDescription = { files : ["OpenSans-LightItalic.ttf"], type : "font", name : "OpenSans_LightItalic"};
	this.OpenSans_LightItalicName = "OpenSans_LightItalic";
	this.OpenSans_LightItalic = null;
	this.OpenSans_LightDescription = { files : ["OpenSans-Light.ttf"], type : "font", name : "OpenSans_Light"};
	this.OpenSans_LightName = "OpenSans_Light";
	this.OpenSans_Light = null;
	this.OpenSans_ItalicDescription = { files : ["OpenSans-Italic.ttf"], type : "font", name : "OpenSans_Italic"};
...
kha_FontList.prototype = {
	...
	,OpenSans_BoldLoad: function(done) {
	...
	,OpenSans_ExtraBoldLoad: function(done) {
	...
	,OpenSans_ExtraBoldItalicLoad: function(done) {
	...
	,OpenSans_ItalicLoad: function(done) {
	...
	,OpenSans_LightLoad: function(done) {
	...
	,OpenSans_LightItalicLoad: function(done) {
	...
	,OpenSans_SemiboldLoad: function(done) {
	...
	,OpenSans_SemiboldItalicLoad: function(done) {
...
kha_SystemImpl.loadFinished = function() {
	...
	try {
		...
		haxe_Log.trace(e,{ fileName : "SystemImpl.hx", lineNumber : 291, className : "kha.SystemImpl", methodName : "loadFinished"});
	}
...
kha_audio2_Audio.stream = function(sound,loop) {
	...
	var element = window.document.createElement("audio");
	element.src = URL.createObjectURL(new Blob([sound.compressedData.b.bufferValue],{ type : "audio/ogg"}));
	element.loop = loop;
...
kha_graphics4_IndexBuffer.prototype = {
	...
	,unlock: function() {
		...
		kha_SystemImpl.gl.bufferData(34963,kha_SystemImpl.elementIndexUint == null?new Uint16Array(this.data):new Uint32Array(this.data),this.usage == kha_graphics4_Usage.DynamicUsage?35048:35044);
	}
	,set: function() {
		kha_SystemImpl.gl.bindBuffer(34963,this.buffer);
	}
...
$hxClasses["share.Share"] = share_Share;
share_Share.__name__ = true;
share_Share.share = function(subject,body,url,attachScreenshot) {
};
